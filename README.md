...
- Доработано с новыми руководствами от Google, Anthropic, Open AI ~ чтобы сделать модели более креативными, лучше запоминающими и более умными
...
- Когда включать думалку? Если вы видите цензуру. Катомная думалка должна тупить модель меньше, чем регексы на пробелы, брейнфаки и длинные NSFW-промпты/пресеты
